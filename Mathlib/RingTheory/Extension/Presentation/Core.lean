...
variable (P) in
/-- The core of a presentation is the subalgebra generated by the coefficients of the
relations. -/
...
noncomputable instance : Algebra P.Core R :=
  fast_instance% (inferInstanceAs <| Algebra P.core R)
instance : FaithfulSMul P.Core R := inferInstanceAs <| FaithfulSMul P.core R
noncomputable instance : Algebra P.Core S :=
  fast_instance% (inferInstanceAs <| Algebra P.core S)
