...
instance : MulAction R' (ContinuousMultilinearMap A M₁ M₂) := wrap_instance%
...
instance : AddMonoid (ContinuousMultilinearMap R M₁ M₂) := wrap_instance%
  toMultilinearMap_injective.addMonoid _ rfl (fun _ _ => rfl) fun _ _ => rfl

instance addCommMonoid : AddCommMonoid (ContinuousMultilinearMap R M₁ M₂) := wrap_instance%
...
instance : AddCommGroup (ContinuousMultilinearMap R M₁ M₂) := wrap_instance%
...
instance : Module R' (ContinuousMultilinearMap A M₁ M₂) := wrap_instance%
